...
// Auto-init: run until data exists (no flag file - retries every request)
$has_data = false;
...
(1, 'Requestor'),(2, 'MDM Business Unit'),(3, 'Direct Manager'),(4, 'BPO Local'),(5, 'MDM Global');
...
";
    ...
    if (!$koneksi->multi_query($sql)) {
        error_log("DB INIT FAILED: " . $koneksi->error);
    } else {
