...
// Detail — hanya yang is_forwarded = 1 (yang lolos dari MDM BU)
...
// Cek sudah general approve di step ini
$sudah_general = true;

if($header['current_step'] == $role && 
...
<?php endif; ?>
    ...
    <div style="text-align:right;margin-top:20px">
        <a href="GM_List.php" class="btn-back">BACK</a>
    </div>
