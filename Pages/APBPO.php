...
$review_pages = [
    ...
    'MDM Business Unit' => 'MDM_Review.php',
    'MDM Global' => 'MDM_Global_Review.php'
];

$review_page = isset($review_pages[$role]) ? $review_pages[$role] : 'Review.php';
?>

<a href="<?= $review_page ?>?id=<?= $row['id'] ?>" class="btn-review">Review</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            <?php else: ?>
